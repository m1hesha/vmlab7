...
*/
    ...
    walls[0] = addRect(QRectF(0,0,10,895),QPen(Qt::white), QBrush(QColor(200, 50, 150)));
    walls[1] = addRect(QRectF(1435,0,10,895), QPen(Qt::white), QBrush(QColor(200, 50, 150)));
    walls[2] = addRect(QRectF(0,0,895,10), QPen(Qt::white), QBrush(QColor(200, 50, 150)));
    walls[3] = addRect(QRectF(0,895,1435,10), QPen(Qt::white), QBrush(QColor(200, 50, 150)));
